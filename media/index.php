...
<head>
	...
	<style>
		...
		.wrap { width: 515px; margin: 1em auto; background: white; padding: 25px; border: solid 1px #ECE9E9; -moz-border-radius: 1px; -webkit-border-radius: 10px; }
...
foreach($files as $file)
{
	...
	echo "<div class=\"media_block\">";
	echo "	<div class=\"media_block_image\"><a href=\"$file\" download=\"$file\" class=\"$fileExt\">&nbsp;</a></div>";
	echo "	<div class=\"media_block_name\">\n";
	echo "		<div class=\"media_block_file\"><a href=\"$file\" download=\"$file\">$file</a></div>\n";
