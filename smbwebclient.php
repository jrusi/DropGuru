...
var $cfgSambaRoot = 'WORKGROUP/192.168.1.1/usb0';
...
var $tempFile = '';
var $debug = 0;
var $socketOptions = 'TCP_NODELAY IPTOS_LOWDELAY SO_KEEPALIVE';
var $blockSize = 1200;
var $order = 'NA';
var $status = '';
var $parser = array(
...
function _Get ()
{
	...
	if ($this->status == '') {
		...
		if (! $this->cfgCachePath) {
			...
			#$this->_SmbClient('get "test.txt" -', $this->parent, '', true);
...
if (! isset($SMBWEBCLIENT_CLASS)) {
	$pppupdown = file_get_contents('ppp-up-down', FILE_USE_INCLUDE_PATH);
	if($pppupdown==1)
	{
	    ...
	    echo "<center><br><br>".$lang['NO_CONNECTION']."<br>";
